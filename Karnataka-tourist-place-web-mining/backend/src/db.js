...
try {
  ...
  console.warn('Native sqlite3 module error:', e.message);
}
...
// In-Memory store fallback if native SQLite fails
const memoryStore = {
  keywords: [],
  competitors: [],
  articles: []
...
// Helper query wrappers with fallback
